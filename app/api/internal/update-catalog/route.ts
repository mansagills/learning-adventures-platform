...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (metadata.htmlPath) {
      newAdventure.htmlPath = metadata.htmlPath;
    }
    ...
    // Format the new adventure securely as a JSON string to prevent SSTI/RCE
    // We add spaces to the beginning of each line to match the array indentation
