...
/**
 * Player for React component games registered in lib/gameLoader.ts.
 * HTML games are handled by the iframe player in ./page.tsx instead.
 */
export default function ReactGamePage({ gameId }: { gameId: string }) {
  ...
  const handleComplete = (score: number) => {
    ...
    // For now, just go back to the games list
    setTimeout(() => {
      router.push('/games');
    }, 2000);
  };
