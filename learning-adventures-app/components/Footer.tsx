          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Transforming education through interactive, engaging content that makes learning an adventure for every child.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="#benefits" className="text-gray-300 hover:text-white transition-colors duration-250 text-sm">
                    Features
                  </Link>
                </li>
                <li>
                  <Link href="#how-it-works" className="text-gray-300 hover:text-white transition-colors duration-250 text-sm">
                    How It Works
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/catalog" className="text-gray-300 hover:text-white transition-colors duration-250 text-sm">
                    Adventure Catalog
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="#faq" className="text-gray-300 hover:text-white transition-colors duration-250 text-sm">
                    FAQ
                  </Link>
                </li>
              </ul>
