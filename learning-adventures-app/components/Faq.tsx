...
export default function Faq() {
  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer: 'Yes! Our platform is designed with accessibility as a core principle. We provide keyboard navigation, screen reader compatibility, high contrast modes, adjustable text sizes, and support for various assistive technologies.'
    },
    {
      id: 'pricing',
      question: 'How much does Learning Adventures cost?',
      answer: 'We offer flexible pricing plans starting at $9.99/month for individual families. All plans include a 14-day free trial with no credit card required, so you can explore our full library risk-free.'
    },
    {
      id: 'offline',
      question: 'Can my child use Learning Adventures without internet?',
      answer: 'Many of our activities can be downloaded for offline use, perfect for travel or areas with limited connectivity. Core learning content remains accessible offline through our mobile app.'
    },
    {
      id: 'progress',
      question: 'How do I track my child\'s learning progress?',
      answer: 'Our comprehensive parent dashboard provides detailed insights including completed activities, skill progression, time spent learning, and areas that may need additional practice.'
    },
    {
      id: 'ai-features',
      question: 'How does the AI personalization work?',
      answer: 'Our adaptive learning AI analyzes your child\'s responses and preferences to customize content difficulty. It identifies knowledge gaps and provides targeted practice while keeping your child appropriately challenged.'
    },
    {
      id: 'privacy',
      question: 'How do you protect my child\'s privacy?',
      answer: 'We take privacy seriously and are fully COPPA compliant. We never share personal information with third parties, use bank-level encryption, and parents have full control over account settings.'
    }
  ];
  ...
  const colors = ['violet', 'pink', 'yellow', 'mint', 'violet', 'pink'] as const;
      ...
      <Container>
        ...
        <div className="text-center mb-12 relative z-10">
          <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-white border-2 border-pg-border rounded-full shadow-pop">
            ...
            <span className="text-sm font-bold text-foreground uppercase tracking-wide">FAQ</span>
          </div>
          ...
          <h2 className="font-outfit text-4xl md:text-5xl font-extrabold text-foreground mb-4">
            ...
            <span className="relative inline-block">
              ...
              <svg className="absolute -bottom-1 left-0 w-full h-3" viewBox="0 0 200 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 4C20 2 40 6 60 4C80 2 100 6 120 4C140 2 160 6 180 4C190 3 198 4 198 4" stroke="#F472B6" strokeWidth="3" strokeLinecap="round"/>
              </svg>
            </span>
          </h2>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4 pr-4">
                      {/* Number prefix */}
                      <span className={`font-outfit text-2xl font-extrabold ${colorClass.number}`}>
                    ...
                    <div className={`flex-shrink-0 w-10 h-10 ${colorClass.icon} border-2 border-pg-border rounded-full flex items-center justify-center shadow-pop transition-transform duration-200 ${isOpen(item.id) ? 'rotate-180' : ''}`}>
          ...
          <div className="card-sticker-featured p-8 text-center relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="candy" size="md">
                <span className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center mr-2">📧</span>
                Contact Support
              </Button>
