...
export default function SocialShare({ adventure, compact = false }: SocialShareProps) {
  ...
  const handleShare = async (platform: 'twitter' | 'facebook' | 'email' | 'copy') => {
          ...
          <>
            ...
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
              ...
              <button
                ...
                className="w-full px-4 py-2 text-left hover:bg-gray-50 flex items-center space-x-3 transition-colors"
              >
                <Icon name={copied ? "check" : "link"} size={18} className={copied ? "text-green-500" : "text-gray-600"} />
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      >
        <Icon name="twitter" size={20} className="text-blue-400 group-hover:text-blue-600" />
      </button>
      ...
      >
        <Icon name="facebook" size={20} className="text-blue-600 group-hover:text-blue-700" />
      </button>
      ...
      >
        <Icon name="mail" size={20} className="text-gray-600 group-hover:text-gray-800" />
      </button>
      ...
      >
        <Icon name={copied ? "check" : "link"} size={20} className={copied ? "text-green-500" : "text-gray-600 group-hover:text-gray-800"} />
      </button>
    </div>
  );
}
