  ...
  const steps = [
    {
      ...
      description: 'Tell us about your child\'s grade level, interests, and learning goals.',
      emoji: '👤',
    ...
    },
    {
      ...
      description: 'Browse our library of interactive games and lessons designed for fun learning.',
      emoji: '🗺️',
      color: 'pink' as const,
    },
    {
      ...
      description: 'Watch your child engage with adaptive content that grows with them.',
      emoji: '📈',
    ...
    },
    {
      number: '04',
      title: 'See Results',
      description: 'Get detailed insights into your child\'s learning journey and achievements.',
      emoji: '🏆',
      color: 'mint' as const,
    }
  ];
      ...
      <Container>
        ...
        <div className="text-center mb-16 relative z-10">
          <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-white border-2 border-pg-border rounded-full shadow-pop">
            ...
            <span className="text-sm font-bold text-foreground uppercase tracking-wide">How It Works</span>
          </div>
          ...
          <h2 className="font-outfit text-4xl md:text-5xl font-extrabold text-foreground mb-4">
            ...
            <span className="relative inline-block">
              ...
              <svg className="absolute -bottom-1 left-0 w-full h-3" viewBox="0 0 200 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 4C20 2 40 6 60 4C80 2 100 6 120 4C140 2 160 6 180 4C190 3 198 4 198 4" stroke="#8B5CF6" strokeWidth="3" strokeLinecap="round"/>
              </svg>
            </span>
            {' '}in 4 Easy Steps
          </h2>
              ...
              <div key={step.number} className="relative">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-12 left-[60%] w-[80%] z-0">
                    <svg className="w-full h-4" viewBox="0 0 100 12" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                      <path d="M0 6C15 3 25 9 40 6C55 3 65 9 80 6C90 4 100 6 100 6" stroke="#E2E8F0" strokeWidth="3" strokeLinecap="round" strokeDasharray="6 4"/>
                    </svg>
                  </div>
                )}
                ...
                <div className="card-sticker group hover:-translate-y-1 transition-all duration-200 ease-bounce text-center relative">
                  {/* Large Number Circle */}
                  <div className={`w-20 h-20 ${colors.bg} border-2 border-pg-border rounded-full ${colors.shadow} flex items-center justify-center mx-auto -mt-2 mb-4 group-hover:scale-110 transition-transform duration-200`}>
                    <span className="font-outfit text-2xl font-extrabold text-white">{step.number}</span>
                  </div>
          ...
          <div className="card-sticker-featured max-w-2xl mx-auto text-center p-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="candy" size="lg">
                <span className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center mr-2">🚀</span>
                Start Free Trial
              </Button>
