        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 mb-2">
              Your preferences help us create a course that fits your schedule and learning style:
            </p>
            <ul className="text-sm text-gray-700 space-y-1 ml-4">
              <li>• <strong>Shorter courses</strong> focus on specific skills with quick wins</li>
              <li>• <strong>Longer courses</strong> provide comprehensive coverage with review cycles</li>
              <li>• <strong>Session length</strong> determines activity complexity and pacing</li>
              <li>• <strong>Component mix</strong> creates variety and addresses multiple learning styles</li>
            </ul>
            <p className="text-sm text-gray-700 mt-2 italic">
              Tip: Most students benefit from a mix of games, videos, and hands-on projects
