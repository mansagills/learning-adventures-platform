...
export default function Hero() {
  ...
  return (
    <section className="relative bg-background pt-20 pb-24 overflow-hidden">
      ...
      <div className="absolute top-48 right-40 w-6 h-6 bg-pg-violet rounded-full opacity-50 animate-float" style={{ animationDelay: '0.5s' }}></div>
      <div className="absolute bottom-32 right-32 w-0 h-0 border-l-[12px] border-l-transparent border-r-[12px] border-r-transparent border-b-[20px] border-b-pg-mint opacity-60 animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-64 left-20 w-5 h-5 bg-pg-yellow rounded-full opacity-50 animate-float" style={{ animationDelay: '1.5s' }}></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 mb-6 px-5 py-2.5 bg-white border-2 border-pg-border rounded-full shadow-pop">
              <span className="w-8 h-8 bg-pg-yellow rounded-full flex items-center justify-center text-lg">🚀</span>
              <span className="text-sm font-bold text-foreground uppercase tracking-wide">Learning Adventures</span>
            </div>
            ...
            <h1 className="font-outfit text-5xl md:text-6xl lg:text-7xl font-extrabold text-foreground mb-6 leading-tight">
              ...
              <span className="relative inline-block">
                ...
                <svg className="absolute -bottom-2 left-0 w-full h-4" viewBox="0 0 200 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2 6C20 2 40 10 60 6C80 2 100 10 120 6C140 2 160 10 180 6C190 4 198 6 198 6" stroke="#F472B6" strokeWidth="4" strokeLinecap="round"/>
                </svg>
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button
                ...
                className="text-lg"
              >
                <span className="w-7 h-7 bg-white/20 rounded-full flex items-center justify-center mr-2">🎉</span>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-pg-mint border-2 border-pg-border rounded-2xl shadow-pop -rotate-6 flex items-center justify-center animate-float" style={{ animationDelay: '1s' }}>
              <span className="text-3xl">🎯</span>
            </div>
            <div className="absolute top-1/3 -right-8 w-14 h-14 bg-pg-pink border-2 border-pg-border rounded-full shadow-pop flex items-center justify-center animate-float" style={{ animationDelay: '2s' }}>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto lg:mx-0">
          ...
          <div className="card-sticker group hover:-translate-y-1 transition-transform duration-200 ease-bounce">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-outfit text-3xl font-bold text-pg-violet">50K+</div>
                <div className="text-sm text-foreground/70 font-medium">Happy Families</div>
              </div>
            </div>
          </div>
          ...
          <div className="card-sticker group hover:-translate-y-1 transition-transform duration-200 ease-bounce">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-outfit text-3xl font-bold text-pg-pink">95%</div>
          ...
          <div className="card-sticker group hover:-translate-y-1 transition-transform duration-200 ease-bounce">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-outfit text-3xl font-bold text-pg-yellow">200+</div>
                <div className="text-sm text-foreground/70 font-medium">Adventures</div>
              </div>
            </div>
          </div>
        </div>
