...
const TEST_GAMES = [
  {
    ...
    description:
      'Feed hungry monsters the correct numbers! Practice counting, addition, and subtraction with cute monster friends.',
    category: 'math',
    type: 'game',
    gradeLevel: ['K', '1', '2', '3'],
    difficulty: 'easy',
  ...
  },
  {
    ...
    description:
      'Solve math problems to find buried treasure! Navigate a pirate map and unlock treasure chests with your math skills.',
    category: 'math',
    type: 'game',
    gradeLevel: ['2', '3', '4', '5'],
    difficulty: 'medium',
  ...
  },
  {
    ...
    description:
      'Fast-paced fraction ordering game! Serve customers the correct pizza slice sizes before time runs out.',
    category: 'math',
    type: 'game',
    gradeLevel: ['3', '4', '5'],
    difficulty: 'medium',
  ...
  },
  {
    ...
    description:
      'Interactive bingo with multiplication tables! Solve problems to mark squares and get BINGO!',
    category: 'math',
    type: 'game',
    gradeLevel: ['3', '4', '5'],
    difficulty: 'medium',
  ...
  },
  {
    ...
    description:
      'Sort shapes based on their properties! Fast-paced geometry game with increasing difficulty.',
    category: 'math',
    type: 'game',
  ...
  },
  {
    ...
    description:
      'Game show format with math categories! Answer questions for points in this exciting quiz game.',
    category: 'math',
    type: 'game',
    gradeLevel: ['2', '3', '4', '5'],
    difficulty: 'medium',
  ...
  },
  {
    ...
    description:
      'Jump along the number line to solve problems! Collect coins and dodge obstacles.',
    category: 'math',
    type: 'game',
    gradeLevel: ['1', '2', '3', '4'],
    difficulty: 'easy',
  ...
  },
  {
    ...
    description:
      'Interactive balance to solve equations! Visual representation of algebraic concepts.',
    category: 'math',
    type: 'game',
    gradeLevel: ['3', '4', '5', '6'],
    difficulty: 'medium',
  ...
  },
  {
    ...
    description:
      'Match math problems with their answers! Time-based challenges and different categories.',
    category: 'math',
    type: 'game',
    gradeLevel: ['1', '2', '3', '4'],
    difficulty: 'easy',
  ...
  },
  {
    ...
    description:
      'Carnival-themed counting games! Ring toss, duck pond, and ball throwing - each practicing different skills.',
    category: 'math',
    type: 'game',
    gradeLevel: ['K', '1', '2'],
    difficulty: 'easy',
  ...
  },
  {
    ...
    description:
      'Build structures using geometric shapes! Constraints require specific calculations.',
    category: 'math',
    type: 'game',
    gradeLevel: ['2', '3', '4', '5'],
    difficulty: 'medium',
  ...
  },
  {
    ...
    description:
      'Buy and sell items with virtual money! Calculate totals and make change in different scenarios.',
    category: 'math',
    type: 'game',
    gradeLevel: ['2', '3', '4'],
    difficulty: 'medium',
  ...
  },
  {
    ...
    description:
      'Race against the clock to solve time problems! Set analog clocks to match digital times.',
    category: 'math',
    type: 'game',
    gradeLevel: ['1', '2', '3'],
    difficulty: 'easy',
