      ...
      math: [
        {
          ...
          learningObjectives: ['Master basic arithmetic operations', 'Improve calculation speed'],
          estimatedTime: '10-15 minutes',
        ...
        },
        {
          ...
          gradeLevel: [request.gradeLevel],
          difficulty: 'medium',
          skills: ['fractions', 'visual learning', 'problem solving'],
          learningObjectives: ['Understand fraction operations', 'Visualize fraction parts'],
        ...
        },
        {
          ...
          gradeLevel: [request.gradeLevel],
          difficulty: 'easy',
          skills: ['shapes', 'spatial reasoning', 'pattern recognition'],
          learningObjectives: ['Identify geometric shapes', 'Understand shape properties'],
      ...
      science: [
        {
          ...
          gradeLevel: [request.gradeLevel],
          difficulty: 'medium',
          skills: ['food chains', 'ecosystem balance', 'cause and effect'],
          learningObjectives: ['Understand ecosystem interdependence', 'Learn about food chains'],
          estimatedTime: '15-20 minutes',
        ...
        },
        {
          ...
          gradeLevel: [request.gradeLevel],
          difficulty: 'easy',
          skills: ['plant biology', 'scientific method', 'observation'],
          learningObjectives: ['Understand plant needs', 'Practice scientific experimentation'],
          estimatedTime: '10-15 minutes',
        ...
        },
        {
          ...
          gradeLevel: [request.gradeLevel],
          difficulty: 'medium',
          skills: ['weather patterns', 'prediction', 'data analysis'],
          learningObjectives: ['Understand weather systems', 'Make predictions from data'],
